...
import com.example.zmp3.Adapter.DanhsachtheloaitheochudeAdapter;
...
public class DanhsachtheloaitheochudeActivity extends AppCompatActivity {
    ...
    private void GetData() {
        ...
        final Call<List<TheLoai>> callback= dataservice.GetTheloaitheochude(chuDe.getIDChuDe());
    ...
    private void init() {
        ...
        toolbartheloaitheochude.setNavigationIcon(R.drawable.ic_back);
        //bắt sự kiện lấy tên title
